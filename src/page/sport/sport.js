...
import { sportCategories } from '../../data/sportdata';
...
const Sport = () => {
  ...
  const productsToShow = selectedSubcategory 
    ? sportCategories.subcategories.find(sub => sub.id === selectedSubcategory)?.products || []
    : sportCategories.subcategories.flatMap(sub => sub.products);
        ...
        <div className="container">
          ...
          <div className="subcategories-grid">
            ...
            >
              ...
              <p>{sportCategories.subcategories.flatMap(sub => sub.products).length} produits</p>
            </div>

            {sportCategories.subcategories.map(subcategory => (
  <div 
    key={subcategory.id}
      ...
      <section ref={productsSectionRef} className="products-section">
        <div className="container">
          <div className="section-header">
            <h2>
              {selectedSubcategory 
                ? `${sportCategories.subcategories.find(sub => sub.id === selectedSubcategory)?.name}`
                : 'Tous les Produits Sports & Loisirs'
              }
