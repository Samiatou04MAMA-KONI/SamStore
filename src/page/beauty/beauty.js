...
const Beauty = () => {
  ...
  const productsToShow = selectedSubcategory 
    ? beautyCategories.subcategories.find(sub => sub.id === selectedSubcategory)?.products || []
    : beautyCategories.subcategories.flatMap(sub => sub.products);
        ...
        <div className="container">
          ...
          <div className="subcategories-grid">
            ...
            >
              ...
              <p>{beautyCategories.subcategories.flatMap(sub => sub.products).length} produits</p>
            </div>

            {beautyCategories.subcategories.map(subcategory => (
  <div 
    key={subcategory.id}
      ...
      <section ref={productsSectionRef} className="products-section">
        <div className="container">
          <div className="section-header">
            <h2>
              {selectedSubcategory 
                ? `${beautyCategories.subcategories.find(sub => sub.id === selectedSubcategory)?.name}`
